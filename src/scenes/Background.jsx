...
const Background = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen w-screen h-screen bg-bgcolor text-textPrimary p-6 lg:p-8">
    <div className="mt-8">
      <img src={profilePhoto} className="w-48 lg:w-64 rounded-full" alt="Profile" />
    </div>
    <div className="text-center mt-8 lg:mt-16">
      <p className="text-lg mb-2">Hello! I am</p>
      <h1 className="text-3xl lg:text-5xl font-bold font-mono text-mediumBlue">
        <ReactTyped 
          strings={[
